<x-guest-layout>
    ...
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100">
        <div
            class="mt-7 w-full relative sm:max-w-md mt-6 px-6 py-4 bg-white border border-gray-200 rounded-xl shadow-sm">
                ...
                <div class="mt-5">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="grid gap-y-4">
                            <!-- Form Group -->
                            <div>
                                <label for="email" class="block text-sm mb-2">Name / Email address</label>
                                <div class="relative">
