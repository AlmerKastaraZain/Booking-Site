        ...
        <div class="p-4 sm:p-7">
            <div class="text-center">
                ...
                <p class="mt-2 text-sm text-gray-600">
                    ...
                    <a class="text-indigo-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                        href="{{ Route('login') }}">
                        Sign in here
                    </a>
                </p>
                        ...
                        <div class="flex items-center">
                            <div class="flex">
                                <input id="terms" name="terms" type="checkbox"
                                    class="shrink-0 mt-0.5 border-gray-200 rounded text-indigo-600 focus:ring-indigo-500">
                            </div>
                            @if (Laravel\Jetstream\Jetstream::hasTermsAndPrivacyPolicyFeature())

                                <div class="ms-3">
                                    <label for="terms" class="text-sm">I accept the <a
                                            class="text-indigo-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                                            href="{{ route('terms.show') }}">Terms and Conditions</a> and <a
                                            class="text-indigo-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium"
                                            href="{{ route('policy.show') }}">Privacy Policy</a></label>
                                </div>
                            @endif

                        </div>
                        <button type="submit"
                            class="w-full py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-indigo-600 text-white hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700 disabled:opacity-50 disabled:pointer-events-none">Sign
                            up</button>
                    </div>
                </form>
                <!-- End Form -->
