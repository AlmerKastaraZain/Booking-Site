<div>
    @if (Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-form-section submit="addTeamMember">
                <x-slot name="title">
                    {{ __('Add Vendor Member') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('Add a new staff member to your Vendor, allowing them to collaborate with you.') }}
                </x-slot>

                <x-slot name="form">
                    <div class="col-span-6">
                        <div class="max-w-xl text-sm text-gray-600">
                            {{ __('Please provide the email address of the person you would like to add to this Vendor.') }}
                        </div>
                    </div>
    ...
    @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                <x-slot name="title">
                    {{ __('Pending Staff Invitations') }}
                </x-slot>

                <x-slot name="description">
                    {{ __('These people have been invited to your Vendor and have been sent an invitation email. They may join the Vendor by accepting the email invitation.') }}
                </x-slot>
