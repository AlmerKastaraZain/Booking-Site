    ...
    <section class="bg-gray-900 h-[100vh] w-[100vw] flex justify-center items-center ">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-sm text-center">
                ...
                <p class="mb-4 text-3xl tracking-tight font-bold  md:text-4xl text-white">Session
                    expired.</p>
                <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">The request failed because the
