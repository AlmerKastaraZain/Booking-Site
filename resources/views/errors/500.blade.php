        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
            <div class="mx-auto max-w-screen-sm text-center">
                <h1 class="mb-8 text-7xl tracking-tight font-extrabold lg:text-9xl text-primary-600 text-white">
                    <span class="bg-indigo-500 px-10">500</span>
                </h1>
                <p class="mb-4 text-3xl tracking-tight font-bold  md:text-4xl text-white">Internal
                    Server Error.</p>
                <p class="mb-4 text-lg font-light text-gray-500 dark:text-gray-400">Problem with the server that hosts a
                    website. Please wait until site is active again!</p>
                <a href="/"
